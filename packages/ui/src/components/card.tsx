...
>(({ className, glass, interactive, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-[var(--radius)] border border-[rgb(var(--color-border))] bg-[rgb(var(--color-surface))] text-[rgb(var(--color-foreground))]",
      glass && "glass border-transparent",
      interactive &&
        "transition-all duration-300 hover:shadow-[var(--shadow-lifted)] hover:-translate-y-0.5",
      className,
    )}
    {...props}
  />
