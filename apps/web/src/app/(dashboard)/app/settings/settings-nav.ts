    ...
    items: [
      {
        ...
        icon: Building2,
        description: "Identity, registration and contact details",
        keywords: ["logo", "name", "tagline", "gst", "registration", "phone", "whatsapp", "email", "website", "address", "maps", "category", "description"],
      },
      {
        id: "branding",
        label: "Branding",
        ...
        icon: Palette,
        description: "Colors, font and favicon",
        keywords: ["color", "primary", "secondary", "accent", "font", "favicon", "preview", "theme color"],
      },
      {
        id: "preferences",
        ...
        icon: Globe2,
        description: "Currency, language, timezone and formats",
        keywords: ["currency", "language", "timezone", "date format", "time format", "region", "locale"],
      },
      {
        id: "hours",
        ...
        icon: Clock3,
        description: "Weekly schedule, breaks and weekly off",
