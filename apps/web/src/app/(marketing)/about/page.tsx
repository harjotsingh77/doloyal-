...
export default function AboutPage() {
  return (
    <div className="overflow-hidden bg-[#FCFBFA] font-[family-name:var(--font-sora)] text-[#282628]">
      ...
      <section className="relative pt-28 pb-12 sm:pt-44 sm:pb-20">
        <div className="mx-auto max-w-[1200px] px-4 sm:px-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <motion.h1
              ...
              className="text-4xl font-extrabold tracking-tight text-[#282628] sm:text-7xl lg:text-[5rem]"
            >
              Our Story
            </motion.h1>
            ...
            <motion.p
              ...
              className="mt-4 sm:mt-6 text-base sm:text-xl leading-relaxed text-[#58585E] font-normal"
            >
          ...
          <motion.div
            ...
            className="mt-10 sm:mt-14 overflow-hidden rounded-[1.8rem] sm:rounded-[2.5rem] border border-black/5 shadow-[0_20px_50px_-15px_rgba(0,0,0,0.08)] bg-white"
          >
      ...
      <section className="py-16 sm:py-28 bg-[#F9F6F4]/60 border-y border-black/5">
        <div className="mx-auto max-w-[1200px] px-4 sm:px-8">
          <div className="text-center max-w-3xl mx-auto">
            <motion.h2
              initial={{ opacity: 0, y: 20 }}
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6, ease: EASE }}
              className="text-2xl sm:text-3xl font-extrabold tracking-tight text-[#282628] sm:text-5xl"
            >
              Insights That Help You Grow
            </motion.h2>
            <p className="mt-3 sm:mt-4 text-sm sm:text-lg text-[#58585E]">
          ...
          <div className="mt-10 sm:mt-16 grid gap-5 sm:gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {INSIGHTS_FEATURES.map((feat, idx) => (
              <motion.div
                ...
                className="rounded-3xl border border-black/5 bg-white p-6 sm:p-8 transition-all duration-300 hover:shadow-xl hover:-translate-y-1"
              >
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#F0F5FF]">
                  {feat.icon}
                </div>
                <h3 className="mt-5 sm:mt-6 text-lg font-bold text-[#282628]">{feat.title}</h3>
                <p className="mt-2 text-[13.5px] sm:text-[14px] leading-relaxed text-[#58585E]">
                  {feat.desc}
                </p>
              </motion.div>
            ))}
      ...
      <section className="py-16 sm:py-28">
        <div className="mx-auto max-w-[1200px] px-4 sm:px-8">
          <div className="relative overflow-hidden rounded-[1.8rem] sm:rounded-[2.5rem] border border-black/10 bg-[#232123] p-6 sm:p-16 text-white shadow-2xl">
            {/* Ambient Background Glow */}
            <div className="pointer-events-none absolute -right-20 -top-20 h-96 w-96 rounded-full bg-[#2563EB]/25 blur-3xl" />

            <div className="relative z-10 grid gap-8 sm:gap-12 lg:grid-cols-12 lg:items-center">
              <div className="lg:col-span-7">
                <span className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-3.5 py-1 sm:px-4 sm:py-1.5 text-[11.5px] sm:text-[12px] font-semibold text-white">
                  <Target className="h-3.5 w-3.5 text-[#3B82F6]" />
                  Our Mission
                </span>
                <h2 className="mt-5 sm:mt-6 text-2xl xs:text-3xl font-extrabold tracking-tight text-white sm:text-5xl sm:leading-[1.15]">
                  Make Every Customer Worth Coming Back For
                </h2>
                <p className="mt-4 sm:mt-6 text-sm sm:text-lg leading-relaxed text-white/80">
                ...
                <p className="mt-3 sm:mt-4 text-sm sm:text-lg leading-relaxed text-white/80">
              ...
              <div className="lg:col-span-5 grid grid-cols-2 gap-3 sm:gap-4">
                <div className="rounded-2xl border border-white/10 bg-white/5 p-4 sm:p-6 backdrop-blur-md">
                  <div className="text-xl sm:text-3xl font-extrabold text-white">1 Month</div>
                  <div className="mt-1 text-xs sm:text-[13px] text-white/60">Free to Start</div>
                </div>
                <div className="rounded-2xl border border-white/10 bg-white/5 p-4 sm:p-6 backdrop-blur-md">
                  <div className="text-xl sm:text-3xl font-extrabold text-[#3B82F6]">All-in-One</div>
                  <div className="mt-1 text-xs sm:text-[13px] text-white/60">Customer Growth Platform</div>
                </div>
                <div className="rounded-2xl border border-white/10 bg-white/5 p-4 sm:p-6 backdrop-blur-md">
                  <div className="text-xl sm:text-3xl font-extrabold text-[#06B6D4]">24/7</div>
                  <div className="mt-1 text-xs sm:text-[13px] text-white/60">Customer Access</div>
                </div>
                <div className="rounded-2xl border border-white/10 bg-white/5 p-4 sm:p-6 backdrop-blur-md">
                  <div className="text-xl sm:text-3xl font-extrabold text-[#109356]">1 Platform</div>
                  <div className="mt-1 text-xs sm:text-[13px] text-white/60">Everything Connected</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="pb-20 sm:pb-32">
        <div className="mx-auto max-w-[1200px] px-4 sm:px-8">
          <div className="grid gap-10 sm:gap-12 lg:grid-cols-12 lg:items-center">
            ...
            >
              <div className="group relative mx-auto max-w-md overflow-hidden rounded-[2rem] sm:rounded-[2.5rem] border border-black/5 bg-white p-5 sm:p-7 shadow-[0_10px_40px_-15px_rgba(0,0,0,0.06)] transition-all duration-500 hover:-translate-y-1.5 hover:shadow-[0_20px_50px_-12px_rgba(37,99,235,0.15)]">
