...
function BookingIcon() {
  return (
    <IconTile>
      <svg viewBox="0 0 40 40" className="h-[58%] w-[58%]" fill="none" aria-hidden="true">
...
function CrmIcon() {
  return (
    <IconTile>
      <svg viewBox="0 0 40 40" className="h-[60%] w-[60%]" fill="none" aria-hidden="true">
...
function AiInsightsIcon() {
  return (
    <IconTile>
      <svg viewBox="0 0 40 40" className="h-[64%] w-[64%]" fill="none" aria-hidden="true">
        <path
